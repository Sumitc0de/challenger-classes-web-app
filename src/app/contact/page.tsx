      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            {/* Call */}
            <a href="tel:+919876543210" className="flex items-center gap-4 bg-white rounded-2xl p-6 border border-border hover:shadow-lg transition-all group">
            ...
            {/* WhatsApp */}
            <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-white rounded-2xl p-6 border border-border hover:shadow-lg transition-all group">
              <div className="w-14 h-14 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0 group-hover:scale-110 transition-transform">
