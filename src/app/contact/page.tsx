      ...
      <section className="section-padding">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-6">
            {/* Call */}
            <a href="tel:+918446288679" className="flex items-center gap-4 bg-white rounded-2xl p-6 border border-border hover:shadow-lg transition-all group">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-primary">+91 84462 88679</p>
              </div>
            </a>

            {/* WhatsApp */}
            <a href="https://wa.me/918446288679" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-white rounded-2xl p-6 border border-border hover:shadow-lg transition-all group">
              <div className="w-14 h-14 rounded-full bg-green-100 flex items-center justify-center text-green-600 shrink-0 group-hover:scale-110 transition-transform">
